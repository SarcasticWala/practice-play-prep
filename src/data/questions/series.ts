...
export const seriesProgressionQuestions: Question[] = [
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Squares of natural numbers: 1², 2², 3², 4², 5², next = 6² = 36.",
  },
  {
    id: "sp-8",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Multiples: 3,6,...,30. Sum = n/2(first+last) = 10/2 × (3+30) = 5 × 33 = 165.",
  },
  {
    id: "sp-10",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "a = 27, r = 1/3. 6th term = ar⁵ = 27 × (1/3)⁵ = 27 × 1/243 = 1/9.",
  },
  {
    id: "sp-12",
    ...
    correctAnswer: 0,
    explanation:
      "a=2, d=3, n=20. Last term = 2+19×3 = 59. Sum = n/2(a+l) = 20/2 × (2+59) = 10 × 61 = 610.",
  },
  {
    id: "sp-13",
    ...
    correctAnswer: 0,
    explanation:
      "Multiply by 2 and add 1: 5×2+1=11, 11×2+1=23, 23×2+1=47, 47×2+1=95, next = 95×2+1 = 191.",
  },
  {
    id: "sp-14",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Differences: +1, +3, +5, +7, next difference = +9 → 19+9 = 28.",
  },
  {
    id: "sp-17",
    ...
    correctAnswer: 0,
    explanation:
      "a=7, d=6, l=103. l = a + (n-1)d → 103 = 7 + (n-1)6 → 96 = (n-1)6 → n-1 = 16 → n = 17.",
  },
  {
    id: "sp-18",
    ...
    correctAnswer: 0,
    explanation:
      "Odd numbers: 1,3,...,99. n = 50. Sum = n/2(first+last) = 50/2 × (1+99) = 25 × 100 = 2500.",
  },
  {
    id: "sp-19",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "n = 50, first=1, last=99. Sum = 50/2 × (1+99) = 25 × 100 = 2500.",
  },
  {
    id: "sp-22",
  ...
  },
  {
    id: "sp-26",
    question:
      "If the 5th term of an AP is 17 and the 9th term is 29, find the common difference.",
    options: ["3", "4", "2", "5"],
    correctAnswer: 0,
  ...
  },
  {
    id: "sp-27",
    question:
      "Find the sum of the series: 1 + 1/2 + 1/4 + 1/8 + ... infinite terms.",
    options: ["2", "1", "1.5", "2.5"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Fibonacci series: each term is sum of previous two. 5+8 = 13.",
  },
  {
    id: "sp-29",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Even numbers: 2,4,...,100. n=50. Sum = 50/2 × (2+100) = 25 × 102 = 2550.",
  },
  {
    id: "sp-31",
  ...
  },
  {
    id: "sp-33",
    question:
      "Find the sum of the series: 1 + 4 + 7 + 10 + ... up to 25 terms.",
    options: ["925", "950", "900", "975"],
    correctAnswer: 0,
    explanation:
      "a=1, d=3, n=25. Last term = 1+24×3 = 73. Sum = 25/2 × (1+73) = 12.5 × 74 = 925.",
  },
  {
    id: "sp-34",
  ...
  },
  {
    id: "sp-38",
    question:
      "If the 3rd term of an AP is 11 and the 7th term is 23, find the first term.",
    options: ["5", "6", "7", "8"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "a=3, d=4, n=30. Last term = 3+29×4 = 119. Sum = 30/2 × (3+119) = 15 × 122 = 1830.",
  },
  {
    id: "sp-43",
    ...
    correctAnswer: 0,
    explanation:
      "Differences: +2, +4, +6, +8, next difference = +10 → 25+10 = 35.",
  },
  {
    id: "sp-44",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Two-digit numbers: 10 to 99. n=90. Sum = 90/2 × (10+99) = 45 × 109 = 4905.",
  },
  {
    id: "sp-46",
    ...
    correctAnswer: 0,
    explanation:
      "Pattern: 0²+1, 1²+1, 2²+1, 3²+1, 4²+1, 5²+1, next = 6²+1 = 37.",
  },
  {
    id: "sp-47",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Differences: +3, +6, +9, +12, next difference = +15 → 31+15 = 46.",
  },
  {
    id: "sp-50",
