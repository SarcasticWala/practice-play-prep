...
export const divisibilityQuestions: Question[] = [
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "7 mod 5 = 2. Cycle of 2^n mod5: 2,4,3,1. 100 mod 4 = 0 → remainder 1.",
  },
  {
    id: "div-4",
    question:
      "A number is divisible by 8 if its last three digits are divisible by 8. Which of the following is divisible by 8?",
    options: ["1234", "2345", "3456", "4567"],
    correctAnswer: 2,
  ...
  },
  {
    id: "div-6",
    question:
      "What is the least number that must be subtracted from 2016 to make it divisible by 11?",
    options: ["2", "3", "4", "5"],
    correctAnswer: 1,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "2340 is even and sum of digits 9 divisible by 3, so divisible by 6.",
  },
  {
    id: "div-8",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Divisible by 9 implies divisible by 3, not necessarily by others.",
  },
  {
    id: "div-11",
  ...
  },
  {
    id: "div-13",
    question:
      "Which digit should replace * in number 1234* to make it divisible by 4?",
    options: ["2", "3", "4", "5"],
    correctAnswer: 2,
    explanation:
      "Last two digits 4* must be divisible by 4; 44 is divisible, so * = 4.",
  },
  {
    id: "div-14",
    question:
      "Find the smallest number that is divisible by all numbers from 1 to 5.",
  ...
  },
  {
    id: "div-15",
    question:
      "If a number N is divisible by both 5 and 12, then N is divisible by:",
    options: ["30", "60", "15", "20"],
    correctAnswer: 1,
  ...
  },
  {
    id: "div-16",
    question:
      "What is the remainder when 3^4 + 3^5 + 3^6 + 3^7 is divided by 9?",
    options: ["0", "3", "6", "1"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Alternating sum for 1234321: (1+3+3+1) - (2+4+2) = 8-8 = 0, divisible by 11.",
  },
  {
    id: "div-18",
    ...
    correctAnswer: 0,
    explanation:
      "Sum of digits = 7+k must be multiple of 3 → k = 2,5,8; among options, 2 works.",
  },
  {
    id: "div-19",
    question:
      "A number leaves remainder 3 when divided by 5. What could be its unit digit?",
    options: ["3 or 8", "2 or 7", "1 or 6", "4 or 9"],
    correctAnswer: 0,
    explanation:
      "Multiples of 5 end in 0 or 5, so remainder 3 gives unit digit 3 or 8.",
  },
  {
    id: "div-20",
  ...
  },
  {
    id: "div-24",
    question:
      "Find the least number which when divided by 6, 7, and 8 leaves remainder 3 in each case.",
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "For 9: 11+x+y multiple of 9 → x+y=7 or 16. For 11: (4+x+5)-(2+y)=7+x-y multiple of 11. With x+y=7, (x,y)=(0,7) gives 7+0-7=0 works. So x+y=7.",
  },
  {
    id: "div-32",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "13 mod5 = 3. Cycle of 3^n mod5: 3,4,2,1. 15 mod4 = 3 → remainder 2.",
  },
  {
    id: "div-42",
  ...
  },
  {
    id: "div-43",
    question:
      "What is the smallest number that leaves remainder 1 when divided by 2, 3, and 5?",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "By Wilson, 16! ≡ -1 mod17, and 16! = 16×15! ≡ -1 ⇒ 15! ≡ 1 mod17.",
  },
  {
    id: "div-46",
