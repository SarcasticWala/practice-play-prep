...
export const clockCalendarQuestions: Question[] = [
  {
    ...
    correctAnswer: 0,
    explanation:
      "At 3:00, hour hand at 3, minute hand at 12. Angle = 3 × 30° = 90°.",
  },
  {
    id: "cc-2",
    ...
    correctAnswer: 0,
    explanation:
      "At 6:00, hour hand at 6, minute hand at 12. Angle = 6 × 30° = 180°.",
  },
  {
    id: "cc-3",
    ...
    correctAnswer: 0,
    explanation:
      "Hour hand at 4 + (20/60)×30 = 4×30 + 10 = 130°. Minute hand at 20×6 = 120°. Difference = 10°.",
  },
  {
    id: "cc-4",
    ...
    correctAnswer: 0,
    explanation:
      "Formula: (60H - 11M)/2 = 0? Better: Time = H × 60/11 = 5 × 60/11 = 300/11 = 27.27 min past 5.",
  },
  {
    id: "cc-5",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Hour hand at 7×30 + (30/60)×30 = 210 + 15 = 225°. Minute hand at 30×6 = 180°. Difference = 45°.",
  },
  {
    id: "cc-7",
    ...
    correctAnswer: 0,
    explanation:
      "Formula: (30H ± 90) × 2/11. For H=8: (240 ± 90)×2/11 = (330×2/11)=60 and (150×2/11)=27.27. So 8:27.27 and 8:60? Actually 60 min past 8 is 9:00, so only 8:27.27.",
  },
  {
    id: "cc-8",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Hour hand at 2×30 + 15 = 75°. Minute hand at 30×6 = 180°. Difference = 105°.",
  },
  {
    id: "cc-11",
    ...
    correctAnswer: 0,
    explanation:
      "30 days later = 2 odd days (since 28 days = 4 weeks exactly). Monday + 2 = Wednesday.",
  },
  {
    id: "cc-12",
    ...
    correctAnswer: 0,
    explanation:
      "Jan 1, 2020 was Wednesday? Actually need reference. But TCS expects you to know: Feb 15, 2020 was Saturday.",
  },
  {
    id: "cc-13",
    ...
    correctAnswer: 0,
    explanation:
      "100 years = 76 ordinary + 24 leap = 76×1 + 24×2 = 76+48 = 124 odd days. 124 mod 7 = 5 odd days.",
  },
  {
    id: "cc-14",
    ...
    correctAnswer: 0,
    explanation:
      "Hour hand at 9×30 + 7.5 = 277.5°. Minute hand at 15×6 = 90°. Difference = 187.5° or 172.5° (smaller angle).",
  },
  {
    id: "cc-15",
    ...
    correctAnswer: 0,
    explanation:
      "For opposite, (30H - 180) × 2/11 = (300 - 180)×2/11 = 120×2/11 = 240/11 = 21.82 min past 10.",
  },
  {
    id: "cc-16",
    question:
      "How many times in a day are the hands of a clock in a straight line but opposite?",
    options: ["22", "24", "11", "12"],
    correctAnswer: 0,
    explanation:
      "They are opposite 11 times in 12 hours, so 22 times in 24 hours.",
  },
  {
    id: "cc-17",
    ...
    correctAnswer: 0,
    explanation:
      "Hour hand at 5×30 + (40/60)×30 = 150 + 20 = 170°. Minute hand at 40×6 = 240°. Difference = 70°.",
  },
  {
    id: "cc-18",
    ...
    correctAnswer: 0,
    explanation:
      "2020 was leap year, so Feb 2020 had 29 days. From Mar 1, 2020 to Mar 1, 2021 = 366 days = 52 weeks + 2 odd days. Sunday + 2 = Tuesday.",
  },
  {
    id: "cc-19",
    ...
    correctAnswer: 0,
    explanation:
      "Hour hand at 12×30 + 15 = 15°. Minute hand at 30×6 = 180°. Difference = 165°.",
  },
  {
    id: "cc-20",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "In 100 years, leap years = 24 (century year not leap unless divisible by 400).",
  },
  {
    id: "cc-22",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Hour hand at 11×30 + (10/60)×30 = 330 + 5 = 335°. Minute hand at 10×6 = 60°. Difference = 275° or 85° (smaller).",
  },
  {
    id: "cc-24",
    ...
    correctAnswer: 0,
    explanation:
      "(30H ± 90) × 2/11 = (60 + 90)×2/11 = 150×2/11 = 300/11 = 27.27 min past 2.",
  },
  {
    id: "cc-25",
    ...
    correctAnswer: 0,
    explanation:
      "They are perpendicular 22 times in 12 hours, so 44 times in 24 hours.",
  },
  {
    id: "cc-26",
    ...
    correctAnswer: 0,
    explanation:
      "Going back one year (2022 not leap year) = 365 days = 52 weeks + 1 odd day. Thursday - 1 = Wednesday.",
  },
  {
    id: "cc-27",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "100 years = 5 odd days. 200 years = 5+5 = 10 mod 7 = 3 odd days.",
  },
  {
    id: "cc-30",
    ...
    correctAnswer: 0,
    explanation:
      "Hour hand at 1×30 + (40/60)×30 = 30 + 20 = 50°. Minute hand at 40×6 = 240°. Difference = 190° or 170° (smaller).",
  },
  {
    id: "cc-31",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "2019 not leap year, so going back 365 days = 1 odd day. Saturday - 1 = Friday.",
  },
  {
    id: "cc-33",
    ...
    correctAnswer: 0,
    explanation:
      "Hour hand at 10×30 + (25/60)×30 = 300 + 12.5 = 312.5°. Minute hand at 25×6 = 150°. Difference = 162.5°.",
  },
  {
    id: "cc-34",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Hour hand at 3×30 + (45/60)×30 = 90 + 22.5 = 112.5°. Minute hand at 45×6 = 270°. Difference = 157.5°.",
  },
  {
    id: "cc-38",
    ...
    correctAnswer: 0,
    explanation:
      "2022 not leap year, 365 days = 1 odd day. Tuesday - 1 = Monday.",
  },
  {
    id: "cc-39",
    ...
    correctAnswer: 0,
    explanation:
      "200 years = 3 odd days. 300 years = 3 + 5 = 8 mod 7 = 1 odd day.",
  },
  {
    id: "cc-40",
    ...
    correctAnswer: 0,
    explanation:
      "(30H - 180) × 2/11 = (330 - 180)×2/11 = 150×2/11 = 300/11 = 27.27? Wait 150×2/11=300/11=27.27, so 11:27.27. But check: At 11:27.27, hour hand at 330 + 13.64 = 343.64°, minute hand at 27.27×6=163.64°, difference=180° ✓. So 11:27.27, not 11:32.73.",
  },
  {
    id: "cc-41",
    ...
    correctAnswer: 0,
    explanation:
      "Hour hand at 2×30 + 7.5 = 67.5°. Minute hand at 15×6 = 90°. Difference = 22.5°.",
  },
  {
    id: "cc-42",
    ...
    correctAnswer: 0,
    explanation:
      "400 years = 4×5 + 1 (for leap century) = 20+1=21 mod 7 = 0 odd days.",
  },
  {
    id: "cc-43",
    ...
    correctAnswer: 0,
    explanation:
      "(30H ± 90) × 2/11 = (30 + 90)×2/11 = 120×2/11 = 240/11 = 21.82 min past 1.",
  },
  {
    id: "cc-44",
    ...
    correctAnswer: 0,
    explanation:
      "Hour hand at 6×30 + 7.5 = 187.5°. Minute hand at 15×6 = 90°. Difference = 97.5°.",
  },
  {
    id: "cc-45",
    ...
    correctAnswer: 0,
    explanation:
      "2024 is leap year, but Oct is after Feb, so from Oct 2, 2023 to Oct 2, 2024 = 366 days = 2 odd days. Monday + 2 = Wednesday.",
  },
  {
    id: "cc-46",
    question:
    ...
    correctAnswer: 0,
    explanation:
      "They form a straight line (coincide or opposite) 44 times in 24 hours (22 coincide + 22 opposite).",
  },
  {
    id: "cc-47",
    question:
      "At what time between 5 and 6 will the hands be at 90° for the first time?",
    options: ["5:10.91", "5:15", "5:12", "5:11"],
    correctAnswer: 0,
    explanation:
      "(30H - 90) × 2/11 = (150 - 90)×2/11 = 60×2/11 = 120/11 = 10.91 min past 5.",
  },
  {
    id: "cc-48",
    ...
    correctAnswer: 0,
    explanation:
      "Hour hand at 4×30 + (40/60)×30 = 120 + 20 = 140°. Minute hand at 40×6 = 240°. Difference = 100°.",
  },
  {
    id: "cc-49",
    ...
    correctAnswer: 0,
    explanation:
      "2023 not leap year, 365 days = 1 odd day. Sunday + 1 = Monday.",
  },
  {
    id: "cc-50",
    ...
    correctAnswer: 0,
    explanation:
      "(30H - 180) × 2/11 = (210 - 180)×2/11 = 30×2/11 = 60/11 = 5.45 min past 7.",
  },
];
