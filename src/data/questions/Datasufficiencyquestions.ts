...
export const dataSufficiencyQuestions: Question[] = [
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Statement I: N/2 is an integer → N is divisible by 2 → N is even. Sufficient.\nStatement II: N + 1 is odd → N is even (even + 1 = odd). Sufficient.\nEither statement alone is sufficient.",
  },
  {
    id: "ds-3",
    question:
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Statement I: AB² + BC² = AC² → by Pythagoras, the triangle is right-angled at B. Sufficient.\nStatement II: Angle B = 90° → directly confirms right-angled triangle. Sufficient.\nEither statement alone is sufficient.",
  },
  {
    id: "ds-6",
    question:
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Let number = 10a+b. Statement I: (10a+b)–(10b+a) = 27 → 9(a–b) = 27 → a–b = 3. Statement II: a+b = 11. Both together: a–b=3 and a+b=11 → 2a=14 → a=7, b=4 → number = 74. Sufficient together.",
  },
  {
    id: "ds-33",
    question:
      "Question: What is the value of the expression 3a – 2b?\nStatement I: a = 5 and b = 3\nStatement II: 6a – 4b = 18\n\nChoose the correct option:",
    options: [
      "Either statement alone is sufficient",
      "Statement I alone is sufficient",
      "Statement II alone is sufficient",
  ...
  // ─── HARD: Tricky, Non-Obvious & Multi-Concept (ds-36 to ds-50) ───
  {
    ...
    correctAnswer: 0,
    explanation:
      "Statement I: x+y=15 and y+z=18. Adding: x+2y+z=33. Cannot find x+y+z without y. Insufficient alone.\nStatement II: x+z=13 and y=8 → x+y+z = 13+8 = 21. Sufficient.\nStatement II alone is sufficient.",
  },
  {
    id: "ds-37",
    question:
      "Question: Is the number N divisible by 12?\nStatement I: N is divisible by 4.\nStatement II: N is divisible by 3.\n\nChoose the correct option:",
    options: [
      "Both statements together are sufficient",
      "Statement I alone is sufficient",
      "Statement II alone is sufficient",
  ...
  },
  {
    id: "ds-41",
    question:
      "Question: Is the quadrilateral PQRS a parallelogram?\nStatement I: PQ = RS and PQ ∥ RS.\nStatement II: PS = QR.\n\nChoose the correct option:",
    options: [
      "Statement I alone is sufficient",
      "Statement II alone is sufficient",
      "Both statements together are sufficient",
  ...
  },
  {
    id: "ds-46",
    question:
      "Question: What is the number of ways to arrange 4 boys and 3 girls in a row such that all girls are together?\nStatement I: There are 4 boys and 3 girls.\nStatement II: Total arrangements with girls always adjacent is 720.\n\nChoose the correct option:",
    options: [
      "Statement I alone is sufficient",
      "Statement II alone is sufficient",
      "Both statements together are sufficient",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Statement I: M is multiple of 2 and 9 → M is multiple of LCM(2,9)=18. Every multiple of 18 is also a multiple of 6 (since 18=6×3). So M is a multiple of 6. Sufficient.\nStatement II: M is multiple of 18 → multiple of 6 (since 6|18). Sufficient.\nEither statement alone is sufficient.",
  },
  {
    id: "ds-49",
    question:
